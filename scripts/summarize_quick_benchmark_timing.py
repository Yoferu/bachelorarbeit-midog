...
def main() -> None:
    ...
    for path in files:
        ...
        rows.append({
            ...
            "tensorrt_engine_reused": data.get("tensorrt_engine_reused"),
            "precision": data.get("precision"),
            "engine_build_time_seconds": data.get("engine_build_time_seconds"),
            "inference_latency_excludes_engine_build": data.get("inference_latency_excludes_engine_build"),
    ...
    summary = {
        ...
        "torch_version": rows[0]["torch_version"],
        "cuda_available": rows[0]["cuda_available"],
        "cuda_device_name": rows[0]["cuda_device_name"],
        "tensorrt_version": rows[0]["tensorrt_version"],
        "onnx_path": rows[0]["onnx_path"],
        "tensorrt_engine_path": rows[0]["tensorrt_engine_path"],
        "tensorrt_engine_reused": rows[0]["tensorrt_engine_reused"],
        "precision": rows[0]["precision"],
        "engine_build_time_seconds": rows[0]["engine_build_time_seconds"],
        "inference_latency_excludes_engine_build": rows[0]["inference_latency_excludes_engine_build"],
