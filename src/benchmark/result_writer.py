...
def write_timing_outputs(
    ...
    if csv_path:
        ...
        flat = {
            ...
            "openvino_version": summary.get("openvino_version"),
            "available_devices": "; ".join(summary.get("available_devices") or []),
            "selected_device": summary.get("selected_device"),
            "source_onnx_path": summary.get("source_onnx_path"),
            "source_onnx_reused": summary.get("source_onnx_reused"),
            ...
            "tensorrt_version": summary.get("tensorrt_version"),
            "onnx_path": summary.get("onnx_path"),
            "tensorrt_engine_path": summary.get("tensorrt_engine_path"),
            "tensorrt_engine_reused": summary.get("tensorrt_engine_reused"),
            "precision": summary.get("precision"),
            "engine_build_time_seconds": summary.get("engine_build_time_seconds"),
            "inference_latency_excludes_engine_build": summary.get("inference_latency_excludes_engine_build"),
