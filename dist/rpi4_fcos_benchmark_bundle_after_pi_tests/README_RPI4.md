...
> **Hardware correction:** The physical device used for these measurements was a
> **Raspberry Pi 5 with four Cortex-A76 CPU cores**. `rpi4` in this directory,
> archive, README filename, scripts, or result paths is incorrect legacy naming
> retained to avoid breaking artifact provenance.
